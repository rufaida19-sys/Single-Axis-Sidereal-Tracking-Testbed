...
*  **[Read the Full Mathematical Derivation](./calculator/theory.pdf)** - A deep dive into the calculus, angular error functions, and the equioscillation principle used to solve this problem.
